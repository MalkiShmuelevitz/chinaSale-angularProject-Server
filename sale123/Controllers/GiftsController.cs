...
namespace sale123.Controllers
{
    ...
    public class GiftsController : ControllerBase
    {
      ...
      static List<Gift> gifts = new()
        {
            new Gift(){Id=1,Name="Shnat Limudim",Donor="Mby",Price=40,Image="1.jpg",UsersList=new List<User>(),Winner=null},
            new Gift(){Id=2,Name="Pamotim",Donor="Mitzhalot",Price=10,Image="2.jpg",UsersList=new List<User>(),Winner=null},
            new Gift(){Id=3,Name="Event",Donor="Shira Chadasha",Price=20,Image="3.jpg",UsersList=new List<User>(),Winner=null},
            new Gift(){Id=4,Name="Camera",Donor="Refaeli",Price=10,Image="4.jpg",UsersList=new List<User>(),Winner=null},
            new Gift(){Id=5,Name="Smash Cake",Donor="Yeudit Avramovsky",Price=10,Image="5.jpg",UsersList=new List<User>(),Winner=null},
            new Gift(){Id=6,Name="Wigs",Donor="Chaya Shteinberger",Price=10,Image="6.jpg",UsersList=new List<User>(),Winner=null},
